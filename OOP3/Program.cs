namespace PlayGround
{
    internal class Program
    {
        ...
        {
            // Q1
            //a method overloading is static binding and only changing the number of arguments ( signature)
            // on the other hand overload resolution is dynamic binding change the implementation of the method.
            //b What is the difference between Static Binding and Dynamic Binding?

            // Q2
            // a) to restrict or completely prevent class inheritance
            // b) applying sealed to a class stops the entire class from being inherited,
            // while applying sealed to a method stops only that specific method from being overridden in future subclasses
            //c) no, i can not, cause  explicitly lock its implementation and prevent any further subclasses from altering its behavior.
